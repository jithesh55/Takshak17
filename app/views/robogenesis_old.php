    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" action="http://takshak.in/2017/public/robogenesis/submit" method="post" class="registration-form" enctype="multipart/form-data">
                    ...
                    <div class="form-member hidden-form-member">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="form-member-1-name" placeholder="Name" class="form-member-name form-optional form-control" id="form-member-1-name" value="<?=$member1name?>">
                        </div>
                        <div class="form-group">
                            <label class="sr-only" for="form-member-1-email">E-Mail</label>
                            <input type="email" name="form-member-1-email" placeholder="E-Mail" class="form-member-name form-optional form-control" id="form-member-1-email" value="<?=$member1name?>">
                        </div>
                        ...
                        <div class="col-sm-4"  style="padding-right:0;padding-left:0;">
                            <div class="form-group">
                                ...
                                <input type="text" name="form-member-1-age" placeholder="Age" class="form-member-age form-optional form-control" id="form-member-1-age" value="<?=$member1age?>">
                            </div>
                        </div>
                    </div>
